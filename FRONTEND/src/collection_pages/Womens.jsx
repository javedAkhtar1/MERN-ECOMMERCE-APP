...
function Womens() {
  ...
  const womensProducts = filteredProducts.filter((p) => p.category === "women")

  return (
    <>
      <Navbar />
      <SearchBar />
      {womensProducts.length == 0 && <div className="text-center text-xl font-Nunito flex justify-center items-center h-[80vh]">Product not found!</div> }
      {loading ? (
